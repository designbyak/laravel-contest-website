...
<body>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="container-fluid">
                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="/" class="">
                                <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>Yehiz</h3>
                            </a>
                            <h3>Email</h3>
                        </div>
            ...
            <button type="submit" class="btn btn-primary py-3 w-100 mb-4">{{ __('Resend Verification Email') }}</button>
            </form>
    ...
    <script src="admin/ib/waypoints/waypoints.min.js"></script>
